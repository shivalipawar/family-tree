...
public class BrotherInLawTest {
    ...
    public void getPersonsShouldReturnListOfBrotherInLawForSpouseBrother() throws CustomException {
        level1Family1.addChild(Either.left(level2Family3));
        level1Family1.addChild(Either.left(level2Family4));
        level1Family1.addChild(Either.right(level2PersonChild6));
